...
public class BookingManagementService : IBookingManagementService
{
    ...
    public async Task<BookingManagementDetailDTO?> GetBookingDetailAsync(Guid id)
    {
        ...
        return new BookingManagementDetailDTO
        {
            Id = b.Id,
            BookingCode = b.QrCode ?? string.Empty,
            BookingType = b.BookingType ?? string.Empty,
            ...
            Seats = b.Tickets
                ...
                .Select(t => new BookingManagementSeatLineDTO
                {
            ...
            Foods = b.BookingFoods.Select(f => new BookingManagementFoodLineDTO
            {
                Name = f.Fb?.Name ?? string.Empty,
                Quantity = f.Quantity,
                UnitPrice = f.PriceAtBooking
            }).ToList(),
            Payments = b.Payments.Select(p => new BookingManagementPaymentLineDTO
            {
    ...
    public async Task<TicketPrintViewModel?> GetTicketPrintAsync(Guid bookingId)
    {
        ...
        return new TicketPrintViewModel
        {
            ...
            Payment = payment is null ? null : new BookingManagementPaymentLineDTO
            {
